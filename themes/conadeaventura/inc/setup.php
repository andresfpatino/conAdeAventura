<?php
if (!function_exists('conadeaventura')) :
    /**
    ...
    */
        load_theme_textdomain('conadeaventura', get_template_directory() . '/languages');
...
add_action('after_setup_theme', 'conadeaventura');
